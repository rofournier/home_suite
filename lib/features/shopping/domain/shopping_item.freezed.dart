...
mixin _$ShoppingItem {
 ...
 String get id; String get text; bool get bought; String get createdBy; DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,text,bought,createdBy,createdAt);

@override
String toString() {
  return 'ShoppingItem(id: $id, text: $text, bought: $bought, createdBy: $createdBy, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String text, bool bought, String createdBy, DateTime createdAt
});
...
/// Create a copy of ShoppingItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? text = null,Object? bought = null,Object? createdBy = null,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String text,  bool bought,  String createdBy,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ShoppingItem() when $default != null:
return $default(_that.id,_that.text,_that.bought,_that.createdBy,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String text,  bool bought,  String createdBy,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _ShoppingItem():
return $default(_that.id,_that.text,_that.bought,_that.createdBy,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String text,  bool bought,  String createdBy,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _ShoppingItem() when $default != null:
return $default(_that.id,_that.text,_that.bought,_that.createdBy,_that.createdAt);case _:
  return null;
...
class _ShoppingItem implements ShoppingItem {
  const _ShoppingItem({required this.id, required this.text, this.bought = false, required this.createdBy, required this.createdAt});
...
/// Create a copy of ShoppingItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? text = null,Object? bought = null,Object? createdBy = null,Object? createdAt = null,}) {
